    ...
    <div class="card">
        <div class="card-body"> 
            ...
            <ul class="nav nav-tabs customtab" role="tablist">
                ...
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#rekapkeg" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Rekap Kegiatan</span></a> </li>
                @if ($dataKegiatan->keg_spj==1)
                <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#rekapspj" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">Rekap SPJ</span></a> </li>
                @endif
            </ul>
            <!-- Tab panes -->
